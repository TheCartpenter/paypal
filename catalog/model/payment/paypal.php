...
class PayPal extends \Opencart\System\Engine\Model {
	...
	/**
	 * Set PayPal Customer Main Token
	 *
	 * @param int    $customer_id
	 * @param string $payment_method
	 * @param string $vault_id
	...
	/**
	 * Get PayPal Customer Main Token
	 *
	 * @param int    $customer_id
	 * @param string $payment_method
	 *
	...
	/**
	 * Get PayPal Order By PayPal Order ID
	 *
	...
	/**
	 * Edit Subscription Remaining Date Next
	 *
	 * @param int    $subscription_id
	 * @param int    $remaining
	 ...
	 *
	 * @param array<string, mixed> $subscription_data
	 * @param array<string, mixed> $order_data
	 * @param array<string, mixed> $paypal_order_data
	 *
	 * @return void
	 */
	public function subscriptionPayment(array $subscription_data, array $order_data, array $paypal_order_data): void {
		$_config = new \Opencart\System\Engine\Config();
		$_config->addPath(DIR_EXTENSION . 'paypal/system/config/');
		$_config->load('paypal');
	 ...
	 * @return array<string, mixed>
	 */
	public function createPayment(array $order_data, array $paypal_order_data, float $price, int $subscription_id, string $subscription_name): array {
		$this->load->language('extension/paypal/payment/paypal');
	 ...
	 * @return \Datetime
	 */
	public function calculateSchedule(string $frequency, \DateTime $next_payment, $cycle) {
